...
namespace modelbox {
class InferenceMindSporeAscendFlowUnitTest : public testing::Test {
 public:
  InferenceMindSporeAscendFlowUnitTest()
...
TEST_F(InferenceMindSporeAscendFlowUnitTest, RunUnit) {
...
TEST_F(InferenceMindSporeAscendFlowUnitTest, RunUnitEncrypt) {
  std::string toml_content = R"(
    [driver]
    skip-default=true
    dir=[")" + test_lib_dir + "\",\"" +
